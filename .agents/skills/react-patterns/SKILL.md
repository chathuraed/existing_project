...
name: react-patterns
version: 2.0.0
description: Comprehensive React 18 patterns expert covering hooks, concurrent features, Suspense, and modern TypeScript development. Use for React development, component architecture, state management, performance optimization, and implementing React 18's features.
language: typescript,javascript,tsx,jsx
framework: react
license: MIT
allowed-tools: Read, Write, Edit, Bash, Grep, Glob
tags: [react, react-18, typescript, javascript, jsx, tsx, hooks, suspense, concurrent-rendering]
category: frontend
subcategories: [components, hooks, state-management, performance, forms, testing]
---

# React Development Patterns

Expert guide for building modern React 18 applications with concurrent features, Suspense, and advanced patterns.

## When to Use

- Building React 18 components with TypeScript/JavaScript
